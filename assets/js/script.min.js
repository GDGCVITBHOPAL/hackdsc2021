...
!function(e, t) {
        ...
        function se(t, e, n, r) {
            ...
            E)) {
                ...
                if (p.qsa && !S[t + " "] && (!v || !v.test(t)) && (1 !== d || "object" !== e.nodeName.toLowerCase())) {
                    ...
                    f = e,
                    1 === d && U.test(t)) {
                        for ((s = e.getAttribute("id")) ? s = s.replace(re, ie) : e.setAttribute("id", s = N),
                        o = (l = h(t)).length; o--; )
                            l[o] = "#" + s + " " + be(l[o]);
                        c = l.join(","),
    ...
    E.each({
        ...
        contents: function(e) {
            return void 0 !== e.contentDocument ? e.contentDocument : (S(e, "template") && (e = e.content || e),
...
function(e, t) {
    ...
    function S(e) {
        var t, o = e.ownerDocument.defaultView.getComputedStyle(e), n = parseFloat(o.marginTop || 0) + parseFloat(o.marginBottom || 0), i = parseFloat(o.marginLeft || 0) + parseFloat(o.marginRight || 0), r;
        return {
                    ...
                    if (0 < i)
                        for (var o = 0; o < i; o++) {
                            var r = this._triggerArray[o]
                              , s = _.getSelectorFromElement(r);
                            null !== s && (g([].slice.call(document.querySelectorAll(s))).hasClass(yt) || g(r).addClass(Tt).attr("aria-expanded", !1))
                        }
                    this.setTransitioning(!0),
...
function(a, b) {
    ...
    n.extend = n.fn.extend = function() {
        ...
        h--); i > h; h++)
            if (null != (e = arguments[h]))
                for (d in e)
                    a = g[d],
                    g !== (c = e[d]) && (j && c && (n.isPlainObject(c) || (b = n.isArray(c))) ? (b ? (b = !1,
    ...
    var t = function(a) {
                ...
                CHILD: function(a, b, c, d, e) {
                    ...
                    : function(b, c, i) {
                        ...
                        if (q) {
                            ...
                            !1 === t)
                                for (; (m = ++n && m && m[p] || (t = n = 0) || o.pop()) && ((h ? m.nodeName.toLowerCase() !== r : 1 !== m.nodeType) || !++t || (s && ((k = (l = m[u] || (m[u] = {}))[m.uniqueID] || (l[m.uniqueID] = {}))[a] = [w, t]),
                                m !== b)); )
                                    ;
        ...
        function ra(a, b, c) {
            ...
            : function(b, c, g) {
                ...
                if (g) {
                    ...
                    for (; b = b[d]; )
                        if (1 === b.nodeType || e) {
                            if ((h = (i = (j = b[u] || (b[u] = {}))[b.uniqueID] || (j[b.uniqueID] = {}))[d]) && h[0] === w && h[1] === f)
                                return k[2] = h[2];
                            if (i[d] = k,
                            k[2] = a(b, c, g))
                                return !0
        ...
        return pa.prototype = d.filters = d.pseudos,
        d.setFilters = new pa,
        g = fa.tokenize = function(a, b) {
            ...
            i = [],
            j = d.preFilter; h; ) {
                for (g in c && !(e = R.exec(h)) || (e && (h = h.slice(e[0].length) || h),
                i.push(f = [])),
                c = !1,
    ...
    n.fn.extend({
        find: function(a) {
            ...
            for (b = 0; e > b; b++)
                n.find(a, d[b], c);
            return (c = this.pushStack(e > 1 ? n.unique(c) : c)).selector = this.selector ? this.selector + " " + a : a,
            c
        },
        filter: function(a) {
    ...
    for (L in n.Callbacks = function(a) {
        ...
        var b, c, d, e, f = [], g = [], h = -1, i = function() {
            ...
            fireWith: function(a, c) {
                return e || (c = [a, (c = c || []).slice ? c.slice() : c],
                g.push(c),
                b || i()),
                this
            },
    ...
    n.extend({
        ...
        ready: function(a) {
            ...
            !0 !== a && --n.readyWait > 0 || (I.resolveWith(d, [n]),
    ...
    n((function() {
        ...
        (e = d.createElement("div")).style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px",
        ...
        if (M(a)) {
            ...
            if (g[h]) {
                if (b && (d = c ? g[h] : g[h].data)) {
                    n.isArray(b) ? b = b.concat(n.map(b, n.camelCase)) : b in d ? b = [b] : b = (b = n.camelCase(b))in d ? [b] : b.split(" "),
                    e = b.length;
                    for (; e--; )
                        delete d[b[e]];
        ...
        data: function(a, b) {
            ...
            if (void 0 === a) {
                ...
                1 === f.nodeType && !n._data(f, "parsedAttrs"))) {
                    for (c = g.length; c--; )
                        g[c] && (0 === (d = g[c].name).indexOf("data-") && P(f, d = n.camelCase(d.slice(5)), e[d]));
    ...
    !function() {
        ...
        b.appendChild(a),
        (c = d.createElement("input")).setAttribute("type", "radio"),
        ...
        for (var f, g, h, i, j, k, m, o = a.length, p = ca(b), q = [], r = 0; o > r; r++)
            if ((g = a[r]) || 0 === g)
                if ("object" === n.type(g))
                    ...
                    !l.tbody)
                        for (f = (g = "table" !== j || ha.test(g) ? "<table>" !== m[1] || ha.test(g) ? 0 : i : i.firstChild) && g.childNodes.length; f--; )
    ...
    n.event = {
        ...
        remove: function(a, b, c, d, e) {
            ...
            if (r && (k = r.events)) {
                for (j = (b = (b || "").match(G) || [""]).length; j--; )
                    if (o = q = (h = oa.exec(b[j]) || [])[1],
                    p = (h[2] || "").split(".").sort(),
                    o) {
                        for (l = n.event.special[o] || {},
                        m = k[o = (d ? l.delegateType : l.bindType) || o] || [],
        ...
        trigger: function(b, c, e, f) {
            ...
            r.sort()),
            h = q.indexOf(":") < 0 && "on" + q,
            (b = b[n.expando] ? b : new n.Event(q,"object" == typeof b && b)).isTrigger = f ? 2 : 3,
            b.namespace = r.join("."),
            ...
            f || !l.trigger || !1 !== l.trigger.apply(e, c))) {
                ...
                for (o = 0; (i = p[o++]) && !b.isPropagationStopped(); )
                    ...
                    (g = (n._data(i, "events") || {})[b.type] && n._data(i, "handle")) && g.apply(i, c),
                    (g = h && i[h]) && g.apply && M(i) && (b.result = g.apply(i, c),
                    !1 === b.result && b.preventDefault());
                if (b.type = q,
                !f && !b.isDefaultPrevented() && (!l._default || !1 === l._default.apply(p.pop(), c)) && M(e) && h && e[q] && !n.isWindow(e)) {
                    (m = e[h]) && (e[h] = null),
                    n.event.triggered = q;
                    try {
                        e[q]()
            ...
            if (h && i.nodeType && ("click" !== a.type || isNaN(a.button) || a.button < 1))
                for (; i != this; i = i.parentNode || this)
                    if (1 === i.nodeType && (!0 !== i.disabled || "click" !== a.type)) {
                        for (d = [],
                        c = 0; h > c; c++)
                            void 0 === d[e = (f = b[c]).selector + " "] && (d[e] = f.needsContext ? n(e, this).index(i) > -1 : n.find(e, this, null, [i]).length),
                            d[e] && d.push(f);
                        d.length && g.push({
                            elem: i,
                            handlers: d
        ...
        mouseHooks: {
            ...
            filter: function(a, b) {
                ...
                return null == a.pageX && null != b.clientX && (f = (e = a.target.ownerDocument || d).documentElement,
                c = e.body,
    ...
    n.Event = function(a, b) {
        ...
        this.type = a.type,
        this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && !1 === a.returnValue ? pa : qa) : this.type = a,
        b && n.extend(this, b),
    ...
    var ta = / jQuery\d+="(?:null|\d+)"/g, ua = new RegExp("<(?:" + ba + ")[\\s/>]","i"), va = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, wa = /<script|<style|<link/i, xa = /checked\s*(?:[^=]|=\s*.checked.)/i, ya = /^true\/(.*)/, za = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Aa, Ba = ca(d).appendChild(d.createElement("div"));
    function Ca(a, b) {
    ...
    function Ha(a, b, c, d) {
        ...
        if (o && (e = (k = ja(b, a[0].ownerDocument, !1, a, d)).firstChild,
        1 === k.childNodes.length && (k = e),
        e || d)) {
            for (h = (i = n.map(ea(k, "script"), Da)).length; o > m; m++)
                g = k,
                m !== p && (g = n.clone(g, !0, !0),
        ...
        clone: function(a, b, c) {
            ...
            if (b)
                if (c)
                    ...
                    Fa(a, f);
            return (d = ea(f, "script")).length > 0 && fa(d, !i && ea(a, "script")),
            d = h = e = null,
            f
        },
        cleanData: function(a, b) {
            for (var d, e, f, g, h = 0, i = n.expando, j = n.cache, k = l.attributes, m = n.event.special; null != (d = a[h]); h++)
                if ((b || M(d)) && (g = (f = d[i]) && j[f])) {
                    if (g.events)
                        for (e in g.events)
        ...
        html: function(a) {
            return Y(this, (function(a) {
                ...
                if ("string" == typeof a && !wa.test(a) && (l.htmlSerialize || !ua.test(a)) && (l.leadingWhitespace || !aa.test(a)) && !da[($.exec(a) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; d > c; c++)
                            1 === (b = this[c] || {}).nodeType && (n.cleanData(ea(b, !1)),
                            b.innerHTML = a);
                        b = 0
                    } catch (e) {}
                }
    ...
    function Ma(a) {
        var b = d
          , c = Ka[a];
        return c || ("none" !== (c = La(a, b)) && c || ((b = ((Ja = (Ja || n("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement))[0].contentWindow || Ja[0].contentDocument).document).write(),
        b.close(),
        c = La(a, b),
        Ja.detach()),
        Ka[a] = c),
    ...
    !function() {
        ...
        if (j.style) {
            function k() {
                ...
                (k = j.appendChild(d.createElement("div"))).style.cssText = j.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0",
                k.style.marginRight = k.style.width = "0",
                j.style.width = "1px",
                g = !parseFloat((a.getComputedStyle(k) || {}).marginRight),
                j.removeChild(k)),
                j.style.display = "none",
                (f = 0 === j.getClientRects().length) && (j.style.display = "",
                j.innerHTML = "<table><tr><td></td><td>t</td></tr></table>",
                j.childNodes[0].style.borderCollapse = "separate",
                (k = j.getElementsByTagName("td"))[0].style.cssText = "margin:0;border:0;padding:0;display:none",
            ...
            (i = d.createElement("div")).style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute",
            j.innerHTML = "",
            i.appendChild(j),
    ...
    Sa = function(a, b, c) {
        ...
        return "" !== (g = (c = c || Ra(a)) ? c.getPropertyValue(b) || c[b] : void 0) && void 0 !== g || n.contains(a.ownerDocument, a) || (g = n.style(a, b)),
    ...
    Sa = function(a, b, c) {
        var d, e, f, g, h = a.style;
        return null == (g = (c = c || Ra(a)) ? c[b] : void 0) && h && h[b] && (g = h[b]),
        Oa.test(g) && !Ta.test(b) && (d = h.left,
        (f = (e = a.runtimeStyle) && e.left) && (e.left = a.currentStyle.left),
    ...
    function cb(a, b) {
        for (var c, d, e, f = [], g = 0, h = a.length; h > g; g++)
            (d = a[g]).style && (f[g] = n._data(d, "olddisplay"),
            c = d.style.display,
            b ? (f[g] || "none" !== c || (d.style.display = ""),
            "" === d.style.display && W(d) && (f[g] = n._data(d, "olddisplay", Ma(d.nodeName)))) : (e = W(d),
            (c && "none" !== c || !e) && n._data(d, "olddisplay", e ? c : n.css(d, "display"))));
        for (g = 0; h > g; g++)
            (d = a[g]).style && (b && "none" !== d.style.display && "" !== d.style.display || (d.style.display = b ? f[g] || "" : "none"));
        return a
    }
    function db(a, b, c) {
        var d = Ya.exec(b);
    ...
    function fb(a, b, c) {
        ...
        if (0 >= e || null == e) {
            if ((0 > (e = Sa(a, b, f)) || null == e) && (e = a.style[b]),
            Oa.test(e))
                return e;
    ...
    n.extend({
        ...
        style: function(a, b, c, d) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                ...
                if ("string" === (f = typeof c) && (e = U.exec(c)) && e[1] && (c = X(a, b, e),
                f = "number"),
        ...
        css: function(a, b, c, d) {
            ...
            (g = n.cssHooks[b] || n.cssHooks[h]) && "get"in g && (f = g.get(a, !0, c)),
            void 0 === f && (f = Sa(a, b, d)),
    ...
    function ob(a, b, c) {
        ...
        "inline" === (k = "none" === (j = n.css(a, "display")) ? n._data(a, "olddisplay") || Ma(a.nodeName) : j) && "none" === n.css(a, "float") && (l.inlineBlockNeedsLayout && "inline" !== Ma(a.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
        ...
        if (n.isEmptyObject(o))
            ...
            for (d in r ? "hidden"in r && (q = r.hidden) : r = n._data(a, "fxshow", {}),
            f && (r.hidden = !q),
            ...
            m.done((function() {
                var b;
                for (b in n._removeData(a, "fxshow"),
                o)
                    n.style(a, b, o[b])
            }
            )),
    ...
    function qb(a, b, c) {
        var d, e, f = 0, g = qb.prefilters.length, h = n.Deferred().always((function() {
            ...
            if (e)
                return !1;
            for (var b = hb || lb(), c = Math.max(0, j.startTime + j.duration - b), d, f = 1 - (c / j.duration || 0), g = 0, i = j.tweens.length; i > g; g++)
                j.tweens[g].run(f);
    ...
    function() {
        ...
        (c = d.createElement("div")).setAttribute("className", "t"),
        c.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",
        a = c.getElementsByTagName("a")[0],
        b.setAttribute("type", "checkbox"),
        c.appendChild(b),
        (a = c.getElementsByTagName("a")[0]).style.cssText = "top:1px",
        ...
        (b = d.createElement("input")).setAttribute("value", ""),
    ...
    n.fn.extend({
        val: function(a) {
            ...
            ))) : e ? (b = n.valHooks[e.type] || n.valHooks[e.nodeName.toLowerCase()]) && "get"in b && void 0 !== (c = b.get(e, "value")) ? c : "string" == typeof (c = e.value) ? c.replace(rb, "") : null == c ? "" : c : void 0
        }
    }),
    n.extend({
        valHooks: {
    ...
    ub = {
        set: function(a, b, c) {
            return !1 === b ? n.removeAttr(a, c) : yb && xb || !wb.test(c) ? a.setAttribute(!xb && n.propFix[c] || c, c) : a[n.camelCase("default-" + c)] = a[c] = !0,
            c
        }
    },
        ...
        toggleClass: function(a, b) {
            ...
            return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : n.isFunction(a) ? this.each((function(c) {
                ...
                if ("string" === c)
                    ...
                    void 0 !== a && "boolean" !== c || ((b = Cb(this)) && n._data(this, "__className__", b),
    ...
    n.parseXML = function(b) {
        ...
        if (!b || "string" != typeof b)
            return null;
        try {
            a.DOMParser ? c = (d = new a.DOMParser).parseFromString(b, "text/xml") : ((c = new a.ActiveXObject("Microsoft.XMLDOM")).async = "false",
            c.loadXML(b))
        } catch (e) {
            c = void 0
        }
    ...
    n.extend({
        ...
        ajax: function(b, c) {
            ...
            2 === u)
                return w;
            for (e in (i = n.event && l.global) && 0 == n.active++ && n.event.trigger("ajaxStart"),
            l.type = l.type.toUpperCase(),
            l.hasContent = !Lb.test(l.type),
            f = l.url,
            l.hasContent || (l.data && (f = l.url += (Fb.test(f) ? "&" : "?") + l.data,
            delete l.data),
            !1 === l.cache && (l.url = Ib.test(f) ? f.replace(Ib, "$1_=" + Eb++) : f + (Fb.test(f) ? "&" : "?") + "_=" + Eb++)),
            ...
            function y(b, c, d, e) {
                ...
                d && (v = Wb(l, w, d)),
                v = Xb(l, v, w, k),
                k ? (l.ifModified && ((x = w.getResponseHeader("Last-Modified")) && (n.lastModified[f] = x),
    ...
    (gc = l.ajax = !!gc) && n.ajaxTransport((function(b) {
        var c;
                ...
                send: function(d, e) {
                    ...
                    b.xhrFields)
                        for (f in b.xhrFields)
                            g[f] = b.xhrFields[f];
                    for (f in b.mimeType && g.overrideMimeType && g.overrideMimeType(b.mimeType),
    ...
    n.ajaxTransport("script", (function(a) {
        if (a.crossDomain) {
            ...
            return {
                send: function(e, f) {
                    (b = d.createElement("script")).async = !0,
    ...
    n.ajaxPrefilter("json jsonp", (function(b, c, d) {
        ...
        h ? b[h] = b[h].replace(kc, "$1" + e) : !1 !== b.jsonp && (b.url += (Fb.test(b.url) ? "&" : "?") + b.jsonp + "=" + e),
    ...
    n.offset = {
        setOffset: function(a, b, c) {
            ...
            f = n.css(a, "top"),
            i = n.css(a, "left"),
            (j = ("absolute" === k || "fixed" === k) && n.inArray("auto", [f, i]) > -1) ? (g = (d = l.position()).top,
...
function(t, i, e) {
    function s(e, s) {
        for (var o in this.wrapper = "string" == typeof e ? i.querySelector(e) : e,
    ...
    function o(t, e, s) {
        ...
        return !0 === s && (o.style.cssText = "position:absolute;z-index:9999",
        ...
        "h" == t ? (!0 === s && (o.style.cssText += ";height:7px;left:2px;right:2px;bottom:0",
        n.style.height = "100%"),
        o.className = "iScrollHorizontalScrollbar") : (!0 === s && (o.style.cssText += ";width:7px;bottom:2px;top:2px;right:1px",
        n.style.width = "100%"),
    ...
    function n(e, s) {
        for (var o in this.wrapper = "string" == typeof s.el ? i.querySelector(s.el) : s.el,
    ...
    var r = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || t.oRequestAnimationFrame || t.msRequestAnimationFrame || function(i) {
      ...
      , h = function() {
        ...
        o.momentum = function(t, i, s, o, n, r) {
            ...
            return a = c / (r = void 0 === r ? 6e-4 : r),
            (h = t + c * c / (2 * r) * (l < 0 ? -1 : 1)) < o ? (h = n ? o - n / 2.5 * (c / 8) : o,
            a = (l = e.abs(h - t)) / c) : h > 0 && (h = n ? n / 2.5 * (c / 8) : 0,
            a = (l = e.abs(t) + h) / c),
            {
        ...
        o.extend(o.ease = {}, {
            ...
            elastic: {
                ...
                fn: function(t) {
                    var i = .22, s;
                    return 0 === t ? 0 : 1 == t ? 1 : .4 * e.pow(2, -10 * t) * e.sin((t - i / 4) * (2 * e.PI) / i) + 1
                }
            }
        }),
        o.tap = function(t, e) {
        ...
        o.click = function(e) {
            var s, o = e.target;
            /(SELECT|INPUT|TEXTAREA)/i.test(o.tagName) || ((s = i.createEvent(t.MouseEvent ? "MouseEvents" : "Event")).initEvent("click", !0, !0),
            s.view = e.view || t,
            s.detail = 1,
    ...
    s.prototype = {
        ...
        _start: function(t) {
            var i;
            if (1 != h.eventType[t.type] && 0 !== (i = t.which ? t.button : t.button < 2 ? 0 : 4 == t.button ? 1 : 2))
                return;
        ...
        _end: function(t) {
            if (this.enabled && h.eventType[t.type] === this.initiated) {
                ...
                var i, s, o = (t.changedTouches && t.changedTouches[0],
        ...
        scrollToElement: function(t, i, s, o, n) {
            if (t = t.nodeType ? t : this.scroller.querySelector(t)) {
                ...
                !0 === s && (s = e.round(t.offsetWidth / 2 - this.wrapper.offsetWidth / 2)),
                !0 === o && (o = e.round(t.offsetHeight / 2 - this.wrapper.offsetHeight / 2)),
                r.left -= s || 0,
                r.top -= o || 0,
                ...
                i = null == i || "auto" === i ? e.max(e.abs(this.x - r.left), e.abs(this.y - r.top)) : i,
        ...
        getComputedPosition: function() {
            ...
            return this.options.useTransform ? (i = +((s = s[h.style.transform].split(")")[0].split(", "))[12] || s[4]),
        ...
        _animate: function(t, i, e, s) {
            function o() {
                ...
                n._translate(t, i),
                void (n.resetPosition(n.options.bounceTime) || n._execEvent("scrollEnd"))) : (f = s(m = (m - c) / e),
                d = (t - a) * f + a,
                u = (i - l) * f + l,
                n._translate(d, u),
...
function(t, i) {
    var e, s = "." + "active", o, n, r = "." + "fp-section" + s, h, a, l = "." + "fp-slide" + s, c, p = "." + "fp-slides", d = "fp-scrollable", u = "." + d;
    ...
    t.iscrollHandler = {
        ...
        create: function(t, e, s) {
            ...
            o.each((function() {
                ...
                (e = new IScroll(t.get(0),s)).on("scrollEnd", (function() {
...
function(t, i, e) {
    $.fn.fp_scrolloverflow = function() {
        ...
        var s = "fp-scrollable", o = "." + s, n, r = "." + "active", h, a = "." + "fp-section", l = a + r, c, p = "." + "fp-slide", d = p + r, u, f = "." + "fp-slides", m, v = "." + "fp-tableCell", g = "fp-responsive", y = "fp-auto-height-responsive";
        ...
        var S = {
            ...
            remove: function(t) {
                var i = t.find(o), e;
                i.length && (i.data("iscrollInstance").destroy(),
                i.data("iscrollInstance", null));
...
function(globals) {
    ...
    var each = function(items, next, callback) {
        ...
        if ("function" != typeof callback && (callback = Function.prototype),
        0 === items.length)
        ...
        items.forEach((function(item, index) {
            next(item, (function(error, transformedItem) {
                if (!returned)
                    ...
                    callback(error)) : (transformed[index] = transformedItem,
                    (count += 1) === items.length ? callback(void 0, transformed) : void 0)
            }
            ))
        }
        ))
    ...
    )) : "undefined" != typeof module && module.exports ? module.exports = each : globals.asyncEach = each
}(this),
function(e, n) {
    "use strict";
    ...
    e.fn.fullpage = function(N) {
        ...
        function ce(e, n) {
            var o = Bn(e);
            void 0 !== n ? zn(e, n) : o.length > 0 && Ne(o)
        }
        function de(e) {
            Ve("right", e)
        }
        ...
        function Se(n, o) {
            ...
            void 0 !== N.sectionsColor[o] && n.css("background-color", N.sectionsColor[o]),
            void 0 !== N.anchors[o] && n.attr("data-anchor", N.anchors[o])
        }
        function ye(n, o) {
            void 0 !== N.anchors[o] && n.hasClass(u) && Ln(N.anchors[o], o),
        ...
        function Ce() {
            ...
            for (var o = 0; o < e(w).length; o++) {
                ...
                void 0 !== a && "" !== a && (i += '<div class="' + O + " " + N.navigationPosition + '">' + a + "</div>"),
                i += "</li>",
                n.find("ul").append(i)
            }
        ...
        function Fe(o) {
            ...
            if (N.autoScrolling && !fo && !a) {
                ...
                d > 200 && (xo = []),
                yo)
                    qe(xo, 10) >= qe(xo, 70) && c && Re(r < 0 ? "down" : "up");
                return !1
            }
            N.fitToSection && ao.stop()
        }
        function Ve(n, o) {
            var t, i = (void 0 === o ? e(S) : o).find(P), a = i.find(R).length;
            if (!(!i.length || ho || a < 2)) {
                var l = i.find(z)
                  , r = null;
                if (!(r = "left" === n ? l.prev(R) : l.next(R)).length) {
                    if (!N.loopHorizontal)
                        return;
        ...
        function Ne(n, o, t) {
            if (void 0 !== n) {
                ...
                e.isFunction(N.onLeave) && !r.localIsResizing && !1 === N.onLeave.call(r.activeSection, r.leavingSection, r.sectionIndex + 1, r.yMovement) || (N.autoScrolling && N.continuousVertical && void 0 !== r.isMovementUp && (!r.isMovementUp && "up" == r.yMovement || r.isMovementUp && "down" == r.yMovement) && (r = We(r)),
        ...
        function Ue(n) {
            if (N.css3 && N.autoScrolling && !N.scrollBar) {
                var o;
                Mn("translate3d(0px, -" + t.round(n.dtop) + "px, 0px)", !0),
        ...
        function Ge(n) {
            var o, t;
            N.lazyLoading && en(n).find("img[data-src], img[data-srcset], source[data-src], video[data-src], audio[data-src], iframe[data-src]").each((function() {
                if (o = e(this),
        ...
        function gn(n, o, t) {
            ...
            N.onSlideLeave && !a.localIsResizing && "none" !== a.xMovement && e.isFunction(N.onSlideLeave) && !1 === N.onSlideLeave.call(a.prevSlide, a.anchorLink, a.sectionIndex + 1, a.prevSlideIndex, a.direction, a.slideIndex) ? void (ho = !1) : (o.addClass(u).siblings().removeClass(u),
        ...
        function Dn(e, n, o, t) {
            var i = "";
            N.anchors.length && !N.lockAnchors && (e ? (void 0 !== o && (i = o),
            void 0 === n && (n = e),
            co = n,
            qn(i + "/" + n)) : void 0 !== e ? (co = n,
            qn(o)) : qn(o)),
            Vn()
        }
        function qn(e) {
        ...
        function Jn(e) {
            var n = t.round(e), o;
            N.css3 && N.autoScrolling && !N.scrollBar ? Mn("translate3d(0px, -" + n + "px, 0px)", !1) : N.autoScrolling && !N.scrollBar ? go.css("top", -n) : ao.scrollTop(n)
        }
        function Zn(e) {
            return {
                "-webkit-transform": e,
    ...
    a.extend(a.fn, {
        validate: function(b) {
            if (this.length) {
                ...
                return c || (this.attr("novalidate", "novalidate"),
    ...
    a.extend(a.validator, {
        ...
        prototype: {
            ...
            element: function(b) {
                ...
                (d = this.groups[f.name]) && a.each(this.groups, (function(a, b) {
                    b === d && a !== f.name && ((e = g.validationTargetFor(g.clean(g.findByName(a)))) && e.name in g.invalid && (g.currentElements.push(e),
                    h = h && g.check(e)))
                }
                )),
                c = !1 !== this.check(f),
            ...
            elementValue: function(b) {
                ...
                return "radio" === f || "checkbox" === f ? this.findByName(b.name).filter(":checked").val() : "number" === f && void 0 !== b.validity ? b.validity.badInput ? "NaN" : e.val() : (c = b.hasAttribute("contenteditable") ? e.text() : e.val(),
                "file" === f ? "C:\\fakepath\\" === c.substr(0, 12) ? c.substr(12) : (d = c.lastIndexOf("/")) >= 0 ? c.substr(d + 1) : (d = c.lastIndexOf("\\")) >= 0 ? c.substr(d + 1) : c : "string" == typeof c ? c.replace(/\r/g, "") : c)
            },
            check: function(b) {
                ...
                if ("function" == typeof f.normalizer) {
                    if ("string" != typeof (i = f.normalizer.call(b, i)))
            ...
            showLabel: function(b, c) {
                ...
                h.html(c)) : (d = h = a("<" + this.settings.errorElement + ">").attr("id", i + "-error").addClass(this.settings.errorClass).html(c || ""),
        ...
        attributeRules: function(b) {
            ...
            for (c in a.validator.methods)
                "required" === c ? ("" === (d = b.getAttribute(c)) && (d = !0),
                d = !!d) : d = f.attr(c),
        ...
        methods: {
            ...
            step: function(b, c, d) {
                var e = a(c).attr("type"), f = "Step attribute on input type " + e + " is not supported.", g = ["text", "number", "range"], h = new RegExp("\\b" + e + "\\b"), i;
                if (e && !h.test(g.join()))
                    throw new Error(f);
    ...
    e.prototype = {
        ...
        _preload: function() {
            ...
            for (i = 0; i < this.settings.slides.length; i++)
                (this.settings.preload || this.settings.preloadImages) && this.settings.slides[i].src && ((s = new Image).src = this.settings.slides[i].src),
        ...
        _video: function(t) {
            ...
            return i[n] ? i[n] : (t instanceof Array == 0 && (t = [t]),
        ...
        _goto: function(s) {
            ...
            void 0 === this.settings.slides[s] && (s = 0),
            this.slide = s;
            ...
            this.support.video && l ? ((a = this._video(l instanceof Array ? l : l.src)).loop = void 0 === l.loop || l.loop,
            a.muted = void 0 === l.mute || l.mute,
            !1 === a.muted ? (a.volume = 0,
...
function($) {
    ...
    $.fn.maximage = function(settings, helperSettings) {
        ...
        "object" != typeof settings && void 0 !== settings || (config = $.extend($.fn.maximage.defaults, settings || {})),
        "string" == typeof settings && (config = $.fn.maximage.defaults),
        $.Body = $("body"),
        $.Window = $(window),
        $.Scroll = $("html, body"),
        $.Events = {
            ...
            var $self = $(this)
              ...
              , Modern = {
                ...
                preload: function(n) {
                    var $img = $("<img/>");
                    $img.load((function() {
                        0 == preload_count && (Cycle.setup(),
                        config.onFirstImageLoaded()),
                        preload_count == $.Slides.length - 1 ? config.onImagesLoaded($self) : (preload_count++,
              ...
              , Old = {
                setup: function() {
                    var c, t, $div;
                    if ($.BrowserTests.msie && !config.overrideMSIEStop && document.execCommand("Stop", !1),
                    $self.html(""),
                    $.Body.addClass("mc-old-browser"),
                    $.Slides.length > 0) {
                        for (var j in $.Scroll.addClass("mc-hide-scrolls"),
                        $.Window.data("h", Utils.sizes().h).data("w", Utils.sizes().w),
                        ...
                        $.Slides)
                            c = 0 == $.Slides[j].content.length ? '<img src="' + $.Slides[j].url + '" />' : $.Slides[j].content,
                            $div = $("<div>" + c + "</div>").attr("class", "mc-image mc-image-n" + j + " " + $.Slides[j].theclass),
                            $self.append($div),
                            0 == $(".mc-image-n" + j).children("img").length || $("div.mc-loader").append($(".mc-image-n" + j).children("img").first().clone().addClass("not-loaded"));
                        Old.preload(),
                        Old.windowResize()
                    }
                },
                preload: function() {
                    var t = setInterval((function() {
                        $(".mc-loader").children("img").each((function(i) {
                            var $img = $(this), $img1;
                            $img.hasClass("not-loaded") && ($img.height() > 0 && ($(this).removeClass("not-loaded"),
                            $("div.mc-image-n" + i).children("img").first().data("h", $img.height()).data("w", $img.width()).data("ar", $img.width() / $img.height()),
                            Old.onceLoaded(i)))
                        }
                        )),
                        0 == $(".not-loaded").length && ($(".mc-loader").remove(),
                        clearInterval(t))
                    }
                    ), 1e3)
                },
                onceLoaded: function(m) {
                    ...
                    config.onFirstImageLoaded()) : m == $.Slides.length - 1 && (Cycle.setup(),
                    $($.Scroll).removeClass("mc-hide-scrolls"),
                    config.onImagesLoaded($self),
                    config.debug && (debug(" - Final Maximage - "),
                    debug($self)))
                },
                maximage: function(p) {
                ...
                doneResizing: function() {
                    ...
                    null != curr_opts && (curr_opts.height = $.Window.data("h"),
              ...
              , Adjust = {
                center: function($item) {
                    config.verticalCenter && $item.css({
                        marginTop: ($item.height() - $.Window.data("h")) / 2 * -1
                    }),
                    config.horizontalCenter && $item.css({
                        marginLeft: ($item.width() - $.Window.data("w")) / 2 * -1
                    })
                },
                fill: function($item) {
                    var $storageEl = $item.is("object") ? $item.parent().first() : $item;
                    "function" == typeof config.backgroundSize ? config.backgroundSize($item) : "cover" == config.backgroundSize ? $.Window.data("w") / $.Window.data("h") < $storageEl.data("ar") ? $item.height($.Window.data("h")).width(($.Window.data("h") * $storageEl.data("ar")).toFixed(0)) : $item.height(($.Window.data("w") / $storageEl.data("ar")).toFixed(0)).width($.Window.data("w")) : "contain" == config.backgroundSize ? $.Window.data("w") / $.Window.data("h") < $storageEl.data("ar") ? $item.height(($.Window.data("w") / $storageEl.data("ar")).toFixed(0)).width($.Window.data("w")) : $item.height($.Window.data("h")).width(($.Window.data("h") * $storageEl.data("ar")).toFixed(0)) : debug("The backgroundSize option was not recognized for older browsers.")
                },
              ...
              , Utils = {
                browser_tests: function() {
                    ...
                    if (config.cssTransitions) {
                        "string" == typeof $div.style[p] && (obj.cssTransitions = !0),
                        p = p.charAt(0).toUpperCase() + p.substr(1);
                        for (var i = 0; i < vendor.length; i++)
                            vendor[i] + p in $div.style && (obj.cssTransitions = !0)
                    }
                    return document.createElement("video").canPlayType && (obj.html5Video = !0),
                    obj.msie = void 0 !== Utils.msie(),
                    config.debug && (debug(" - Browser Test - "),
                    debug(obj)),
                    obj
                },
                construct_slide_object: function() {
                    var obj = new Object
                      , arr = new Array
                      , temp = "";
                    return $self.children().each((function(i) {
                        var $img = $(this).is("img") ? $(this).clone() : $(this).find("img").first().clone();
                        (obj = {}).url = $img.attr("src"),
                        obj.title = null != $img.attr("title") ? $img.attr("title") : "",
                        obj.alt = null != $img.attr("alt") ? $img.attr("alt") : "",
                        obj.theclass = null != $img.attr("class") ? $img.attr("class") : "",
                        obj.styles = null != $img.attr("style") ? $img.attr("style") : "",
                        obj.orig = $img.clone(),
                        obj.datahref = null != $img.attr("data-href") ? $img.attr("data-href") : "",
                        obj.content = "",
                        $(this).find("img").length > 0 && ($.BrowserTests.cssBackgroundSize && $(this).find("img").first().remove(),
                        obj.content = $(this).html()),
                        $img[0].src = "",
                        $.BrowserTests.cssBackgroundSize && $(this).remove(),
                        arr.push(obj)
                    }
                    )),
                    config.debug && (debug(" - Slide Object - "),
                    debug(arr)),
                    arr
                },
                msie: function() {
                    for (var undef, v = 3, div = document.createElement("div"), all = div.getElementsByTagName("i"); div.innerHTML = "\x3c!--[if gt IE " + ++v + "]><i></i><![endif]--\x3e",
                    all[0]; )
                        ;
                    return v > 4 ? v : undef
                },
                sizes: function() {
                    ...
                    if ("window" == config.fillElement)
                        sizes.h = $.Window.height(),
                        sizes.w = $.Window.width();
                    else {
                        var $fillElement = $self.parents(config.fillElement).first();
                        0 == $fillElement.height() || 1 == $fillElement.data("windowHeight") ? ($fillElement.data("windowHeight", !0),
                        sizes.h = $.Window.height()) : sizes.h = $fillElement.height(),
                        0 == $fillElement.width() || 1 == $fillElement.data("windowWidth") ? ($fillElement.data("windowWidth", !0),
                        sizes.w = $.Window.width()) : sizes.w = $fillElement.width()
                    }
                    return sizes
                }
            };
            if ($.BrowserTests = Utils.browser_tests(),
            "string" == typeof settings) {
                if ($.BrowserTests.html5Video || !$self.is("video")) {
                    var to, $storageEl = $self.is("object") ? $self.parent().first() : $self;
                    $.Body.hasClass("mc-old-browser") || $.Body.addClass("mc-old-browser"),
                    $.Window.data("h", Utils.sizes().h).data("w", Utils.sizes().w),
                ...
                $.BrowserTests.cssBackgroundSize ? (config.debug && debug(" - Using Modern - "),
                Modern.setup()) : (config.debug && debug(" - Using Old - "),
                Old.setup())
        }
        ))
    }
    ...
    a.okvideo = function(c) {
        ...
        d.setOptions = function() {
            for (var b in this.options)
                !0 === this.options[b] && (this.options[b] = 1),
                !1 === this.options[b] && (this.options[b] = 3);
...
function() {
    ...
    var e, a = function(s, i) {
        ...
        function l(e, a) {
            a = a || {};
            var t, s = new (window.MutationObserver || window.WebkitMutationObserver)((function(e) {
        ...
        0 !== T.container.length)) {
            ...
            T.loadImage = function(e, a, t, s, i, r) {
                ...
                var o;
                e.complete && i ? n() : a ? ((o = new window.Image).onload = n,
                o.onerror = n,
                s && (o.sizes = s),
                t && (o.srcset = t),
                a && (o.src = a)) : n()
            ...
            T.preloadImages = function() {
                function e() {
                    null != T && T && (void 0 !== T.imagesLoaded && T.imagesLoaded++,
            ...
            T.updateSlidesSize = function() {
                ...
                if (void 0 !== T.size) {
                    ...
                    var o, l = T.params.slidesPerColumn, p = n / l, d = p - (T.params.slidesPerColumn * p - T.slides.length), g;
                    for (e = 0; e < T.slides.length; e++) {
                        o = 0;
                        var u = T.slides.eq(e), c, m, h;
                        if (T.params.slidesPerColumn > 1)
                            "column" === T.params.slidesPerColumnFill ? (h = e - (m = Math.floor(e / l)) * l,
                    ...
                    if (T.virtualSize = Math.max(T.virtualSize, T.size) + T.params.slidesOffsetAfter,
                    T.rtl && T.wrongRTL && ("slide" === T.params.effect || "coverflow" === T.params.effect) && T.wrapper.css({
            ...
            T.currentSlidesPerView = function() {
                ...
                if (T.params.centeredSlides) {
                    ...
                    for (e = T.activeIndex + 1; e < T.slides.length; e++)
                        T.slides[e] && !s && (t++,
                        (i += T.slides[e].swiperSlideSize) > T.size && (s = !0));
                    for (a = T.activeIndex - 1; a >= 0; a--)
                        T.slides[a] && !s && (t++,
                        (i += T.slides[a].swiperSlideSize) > T.size && (s = !0))
                } else
                    for (e = T.activeIndex + 1; e < T.slides.length; e++)
            ...
            T.updateClasses = function() {
                ...
                if (T.params.loop && 0 === s.length && (s = T.slides.eq(-1)).addClass(T.params.slidePrevClass),
                ...
                T.paginationContainer && T.paginationContainer.length > 0) {
                    ...
                    if (T.params.loop ? ((r = Math.ceil((T.activeIndex - T.loopedSlides) / T.params.slidesPerGroup)) > T.slides.length - 1 - 2 * T.loopedSlides && (r -= T.slides.length - 2 * T.loopedSlides),
                    r > n - 1 && (r -= n),
            ...
            T.update = function(e) {
                ...
                T.params.freeMode ? (a(),
                T.params.autoHeight && T.updateAutoHeight()) : (("auto" === T.params.slidesPerView || T.params.slidesPerView > 1) && T.isEnd && !T.params.centeredSlides ? T.slideTo(T.slides.length - 1, 0, !1, !0) : T.slideTo(T.activeIndex, 0, !1, !0)) || a()) : T.params.autoHeight && T.updateAutoHeight())
            }
            ,
            ...
            ;
            var S, C, z, M, E, P, I, k, L, D, B = "input, select, textarea, button, video", H = Date.now(), G = [], X, A;
            for (var Y in T.animating = !1,
            T.touches = {
                startX: 0,
                startY: 0,
                currentX: 0,
            ...
            T.onTouchEnd = function(a) {
                ...
                S) {
                    ...
                    !S || !C || !T.swipeDirection || 0 === T.touches.diff || P === I)
                        return void (S = C = !1);
                    if (S = C = !1,
                    i = T.params.followFinger ? T.rtl ? T.translate : -T.translate : -P,
                    T.params.freeMode) {
                        if (i < -T.minTranslate())
            ...
            T.setWrapperTranslate = function(e, a, t) {
                ...
                (n = 0 === o ? 0 : (e - T.minTranslate()) / o) !== T.progress && T.updateProgress(e),
            ...
            T.getTranslate = function(e, a) {
                ...
                window.WebKitCSSMatrix ? ((s = i.transform || i.webkitTransform).split(",").length > 6 && (s = s.split(", ").map((function(e) {
                    return e.replace(",", ".")
                }
                )).join(", ")),
                r = new window.WebKitCSSMatrix("none" === s ? "" : s)) : t = (r = i.MozTransform || i.OTransform || i.MsTransform || i.msTransform || i.transform || i.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","),
            ...
            T.effects = {
                fade: {
                    setTranslate: function() {
                        for (var e = 0; e < T.slides.length; e++) {
                            var a = T.slides.eq(e), t, s = -a[0].swiperSlideOffset;
                ...
                flip: {
                    setTranslate: function() {
                        for (var a = 0; a < T.slides.length; a++) {
                            ...
                            var i, r, n = -180 * s, o = 0, l = -t[0].swiperSlideOffset, p = 0;
                ...
                cube: {
                    setTranslate: function() {
                        var a, t = 0;
                        T.params.cube.shadow && (T.isHorizontal() ? (0 === (a = T.wrapper.find(".swiper-cube-shadow")).length && (a = e('<div class="swiper-cube-shadow"></div>'),
                        T.wrapper.append(a)),
                        a.css({
                            height: T.width + "px"
                        })) : 0 === (a = T.container.find(".swiper-cube-shadow")).length && (a = e('<div class="swiper-cube-shadow"></div>'),
                ...
                coverflow: {
                    setTranslate: function() {
                        for (var a = T.translate, t = T.isHorizontal() ? -a + T.width / 2 : -a + T.height / 2, s = T.isHorizontal() ? T.params.coverflow.rotate : -T.params.coverflow.rotate, i = T.params.coverflow.depth, r = 0, n = T.slides.length; r < n; r++) {
                            var o = T.slides.eq(r), l = T.slidesSizesGrid[r], p, d = (t - o[0].swiperSlideOffset - l / 2) / l * T.params.coverflow.modifier, u = T.isHorizontal() ? s * d : 0, c = T.isHorizontal() ? 0 : s * d, m = -i * Math.abs(d), h = T.isHorizontal() ? 0 : T.params.coverflow.stretch * d, g = T.isHorizontal() ? T.params.coverflow.stretch * d : 0;
                            Math.abs(g) < .001 && (g = 0),
                            Math.abs(h) < .001 && (h = 0),
                            Math.abs(m) < .001 && (m = 0),
                            Math.abs(u) < .001 && (u = 0),
            ...
            T.scrollbar = {
                ...
                setDragPosition: function(e) {
                    var a = T.scrollbar, t, s = (T.isHorizontal() ? "touchstart" === e.type || "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX || e.clientX : "touchstart" === e.type || "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY || e.clientY) - a.track.offset()[T.isHorizontal() ? "left" : "top"] - a.dragSize / 2, i = -T.minTranslate() * a.moveDivider, r = -T.maxTranslate() * a.moveDivider;
                    s < i ? s = i : s > r && (s = r),
                    s = -s / a.moveDivider,
                    T.updateProgress(s),
                ...
                setTranslate: function() {
                    if (T.params.scrollbar) {
                        ...
                        T.rtl && T.isHorizontal() ? (e = -e) > 0 ? (t = a.dragSize - e,
            ...
            T.zoom = {
                ...
                toggleZoom: function(a, t) {
                    var s = a.zoom, i, r, n, o, l, p, d, u, c, m, h, g, f, v, w, y, x, T;
                    (s.gesture.slide || (s.gesture.slide = a.clickedSlide ? e(a.clickedSlide) : a.slides.eq(a.activeIndex),
                    s.gesture.image = s.gesture.slide.find("img, svg, canvas"),
                    s.gesture.imageWrap = s.gesture.image.parent("." + a.params.zoomContainerClass)),
                    s.gesture.image && 0 !== s.gesture.image.length) && (void 0 === s.image.touchesStart.x && t ? (i = "touchend" === t.type ? t.changedTouches[0].pageX : t.pageX,
                    ...
                    l = (n = s.gesture.slide.offset().left) + x / 2 - i,
                    p = (o = s.gesture.slide.offset().top) + T / 2 - r,
                    c = s.gesture.image[0].offsetWidth,
                    m = s.gesture.image[0].offsetHeight,
                    h = c * s.scale,
                    g = m * s.scale,
                    w = -(f = Math.min(x / 2 - h / 2, 0)),
                    y = -(v = Math.min(T / 2 - g / 2, 0)),
                    (d = l * s.scale) < f && (d = f),
                    d > w && (d = w),
                    (u = p * s.scale) < v && (u = v),
                    u > y && (u = y)) : (d = 0,
            ...
            T.emit = function(e) {
                var a;
                if (T.params[e] && T.params[e](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]),
        ...
        return e.prototype = {
            ...
            eq: function(a) {
                if (void 0 === a)
                    return this;
                var t, s = this.length;
                return a > s - 1 ? new e([]) : a < 0 ? new e((t = s + a) < 0 ? [] : [this[t]]) : new e([this[a]])
            },
            append: function(a) {
                var t, s;
                for (t = 0; t < this.length; t++)
    ...
    (r = void 0 === t ? window.Dom7 || window.Zepto || window.jQuery : t) && ("transitionEnd"in r.fn || (r.fn.transitionEnd = function(e) {
        function a(r) {
            if (r.target === this)
                for (e.call(this, r),
                t = 0; t < s.length; t++)
...
function($) {
    $.fn.initForm = function(options) {
        var settings = $.extend({
          ...
          , $ajax_sendRequest = function(p) {
            var form_fill, form_inputs = $(p).find(":input"), form_data = {};
            ...
            $.ajax({
                ...
                success: function(data) {
                    data && !data.error ? (settings.successClean.val(""),
                    ...
                    console.log("Request sent successfully")) : (settings.textFeedback.removeClass("gone"),
        ...
        this.submit((function(event) {
            ...
            jQuery.validator ? $(this).valid() && $ajax_sendRequest(this) : $ajax_sendRequest(this)
        }
        ))
    }
}(jQuery),
...
$(document).on("ready", (function() {
    ...
    for (var list = $(".bg-color"), i = 0; i < list.length; i++) {
    ...
    var menuItems = $(".all-menu-wrapper .nav-link")
      , menuIcon = $(".menu-icon, #navMenuIcon")
      , menuBlock = $(".all-menu-wrapper")
      , reactToMenu = $(".page-main, .navbar-sidebar, .page-cover")
      , menuLinks = $(".navbar-mainmenu a, .navbar-sidebar a");
    menuIcon.on("click", (function() {
        return menuIcon.toggleClass("menu-visible"),
    ...
    menuLinks.on("click", (function() {
        return menuIcon.removeClass("menu-visible"),
    ...
    var pageSectionDivs = $(".page-fullpage .section")
      ...
      , mainPage = $("#mainpage")
      , resp = !0;
    (contextWindow.width() < 768 || contextWindow.height() < 680) && (resp = !1);
    ...
    window.asyncEach(pageSections, (function(pageSection, cb) {
        ...
        console.log(resp),
        mainPage.width() && mainPage.fullpage({
            menu: "#qmenu",
            lockAnchors: !1,
            anchors: pageAnchors,
            verticalCentered: !1,
            ...
            afterRender: function() {
                ...
                if (!!document.documentMode) {
                    ...
                    for (var i = 0; i < contentColumns.length; i++)
                        contentColumns[i].height <= contextWindow.height() && (contentColumns[i].style.height = "100vh")
                }
            },
            ...
            afterLoad: function(anchorLink, index) {
                0 === index ? $.fn.fullpage.setAllowScrolling(!1, "up") : $.fn.fullpage.setAllowScrolling(!0, "up")
            }
        }),
        $(window).on("scroll", event=>{
            0 === $(this).scrollTop() && $(window).scrollTop(1)
        }
        )
    }
    )),
    ...
    contextWindow.on("scroll", (function() {
        var scrollpos = $(this).scrollTop()
          , siteHeaderFooter = $(".page-footer, .page-header");
        scrollpos > 100 ? siteHeaderFooter.addClass("scrolled") : siteHeaderFooter.removeClass("scrolled")
    }
    )),
...
function(e, t) {
    ...
    return function(e) {
        ...
        , r, a = (o(n(1)),
        n(6)), u = o(a), c, f = o(n(7)), s, d = o(n(8)), l, p = o(n(9)), m, b = o(n(10)), v, y = o(n(11)), g, h = o(n(14)), w = [], k = !1, x = document.all && !window.atob, j = {
            offset: 120,
            delay: 0,
            easing: "ease",
            duration: 400,
    ...
    , function(e, t) {
        (function(t) {
            ...
            function r(e) {
                return "symbol" == (void 0 === e ? "undefined" : u(e)) || i(e) && w.call(e) == s
            }
            function a(e) {
                if ("number" == typeof e)
                    return e;
    ...
    , function(e, t) {
        ...
        function o(e) {
            e && e.forEach((function(e) {
                var t = Array.prototype.slice.call(e.addedNodes), n = Array.prototype.slice.call(e.removedNodes), o;
...
$((function() {
    counter = {};
    const HackDSC = new Date;
    HackDSC.setFullYear(2021, 3, 24),
    HackDSC.setHours(10),
    HackDSC.setMinutes(0),
    HackDSC.setSeconds(0);
    console.log(HackDSC,"initial")
    const Now = new Date
      , Test = HackDSC - Now;
      console.log(Now)
      console.log(Test)
      var sec = Math.floor(Test / 1e3);
    counter.days = Math.floor(sec / 86400),
    sec -= 86400 * counter.days,
    counter.hours = Math.floor(sec / 3600),
    sec -= 3600 * counter.hours,
    ...
    ,
    counter.set(),
    counter.tick = ()=>0 !== counter.sec ? (counter.sec--,
    counter.set(),
    0) : 0 !== counter.min ? (counter.min--,
    counter.sec = 59,
    counter.set(),
    0) : 0 !== counter.hours ? (counter.hours--,
    counter.min = 59,
    counter.sec = 59,
    counter.set(),
    0) : 0 !== counter.days ? (counter.days--,
    counter.hours = 23,
    counter.min = 59,
    counter.sec = 59,
    counter.set(),
    0) : void clearInterval(Timer);
