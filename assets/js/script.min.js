...
!(function (e, t) {
  ...
  (function (e, t) {
    ...
    function v(e, t, r, p) {
      ...
      if ("viewport" === p) d = w(l, s);
        ...
        var f;
        "scrollParent" === p
          ? "BODY" === (f = n(o(t))).nodeName &&
            (f = e.ownerDocument.documentElement)
          : (f = "window" === p ? e.ownerDocument.documentElement : p);
        var m = b(f, l, s);
    ...
    function S(e) {
      var t,
        o = e.ownerDocument.defaultView.getComputedStyle(e),
    ...
    function P(t, o, n) {
      var i;
      return (
        (void 0 === n ? t : t.slice(0, N(t, "name", n))).forEach(function (t) {
          t.function &&
            console.warn(
          ...
          arrow: {
            ...
            fn: function (e, o) {
              ...
              return (
                (v = ee(Q(s[l] - u, v), 0)),
                (e.arrowElement = i),
                (e.offsets.arrow = (ae((n = {}), m, $(v)), ae(n, h, ""), n)),
                e
              );
            },
            element: "[x-arrow]",
  ...
  (function (a, b) {
                    ...
                    if (((o = [g ? q.firstChild : q.lastChild]), g && s)) {
                      ...
                      (s &&
                        (t = n =
                          (j =
                            (k =
                              (l = (m = b)[u] || (m[u] = {}))[m.uniqueID] ||
                              (l[m.uniqueID] = {}))[a] || [])[0] === w && j[1]),
                      !1 === t)
                    )
                      for (
                        ;
    ...
    (n.filter = function (a, b, c) {
      ...
      n.fn.extend({
        find: function (a) {
          ...
          return (
            ((c = this.pushStack(e > 1 ? n.unique(c) : c)).selector = this
              .selector
              ? this.selector + " " + a
              : a),
            c
        ...
        if (g[h]) {
          if (b && (d = c ? g[h] : g[h].data)) {
            n.isArray(b)
              ...
              : b in d
              ? (b = [b])
              : (b = (b = n.camelCase(b)) in d ? [b] : b.split(" ")),
              (e = b.length);
            for (; e--; ) delete d[b[e]];
    ...
    n.extend({
      ...
      hasData: function (a) {
        return (
          !!(a = a.nodeType ? n.cache[a[n.expando]] : a[n.expando]) && !Q(a)
        );
      },
      data: function (a, b, c) {
        return R(a, b, c);
            ...
            if (
              ...
              for (c = g.length; c--; )
                g[c] &&
                  ...
                  P(f, (d = n.camelCase(d.slice(5))), e[d]);
      ...
      (function () {
        ...
        l.shrinkWrapBlocks = function () {
          return null != a
            ? a
            : ((a = !1),
              (c = d.getElementsByTagName("body")[0]) && c.style
                ? ((b = d.createElement("div")),
                  ((e = d.createElement("div")).style.cssText =
                    "position:absolute;border:0;width:0;height:0;top:0;left:-9999px"),
                  c.appendChild(e).appendChild(b),
    ...
    var Y = function (a, b, c, d, e, f, g) {
        var h = 0,
          ...
          j = null == c;
        if ("object" === n.type(c))
          for (h in ((e = !0), c)) Y(a, b, h, c[h], !0, f, g);
        else if (
          void 0 !== d &&
          ((e = !0),
          n.isFunction(d) || (g = !0),
            ...
            if (
              ...
              for (
                  ...
                  (g =
                    "table" !== j || ha.test(g)
                      ? "<table>" !== m[1] || ha.test(g)
                        ? 0
                        : i
                      : i.firstChild) && g.childNodes.length;
                f--;
                ...
                n.nodeName((k = g.childNodes[f]), "tbody") &&
                  !k.childNodes.length &&
                  g.removeChild(k);
            for (n.merge(q, i.childNodes), i.textContent = ""; i.firstChild; )
    ...
    (n.event = {
      ...
      add: function (a, b, c, d, e) {
        ...
        if (r) {
          for (
            c.handler && ((c = (i = c).handler), (e = i.selector)),
      ...
      trigger: function (b, c, e, f) {
        ...
        if (
          ...
          3 !== e.nodeType &&
            ...
            ((b = b[n.expando]
              ? b
              : new n.Event(q, "object" == typeof b && b)).isTrigger = f
              ? 2
              : 3),
            (b.namespace = r.join(".")),
          ...
          if (
            ...
            (m = e[h]) && (e[h] = null), (n.event.triggered = q);
            try {
              e[q]();
            } catch (s) {}
      ...
      mouseHooks: {
        ...
        filter: function (a, b) {
          ...
          return (
            null == a.pageX &&
              null != b.clientX &&
              ((f = (e = a.target.ownerDocument || d).documentElement),
              (c = e.body),
              (a.pageX =
                b.clientX +
    ...
    var ta = / jQuery\d+="(?:null|\d+)"/g,
      ...
      za = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
      Aa,
      Ba = ca(d).appendChild(d.createElement("div"));
    function Ca(a, b) {
    ...
    function Ha(a, b, c, d) {
      ...
      if (
        o &&
        ((e = (k = ja(b, a[0].ownerDocument, !1, a, d)).firstChild),
    ...
    n.extend({
      ...
      clone: function (a, b, c) {
        ...
        return (
          (d = ea(f, "script")).length > 0 && fa(d, !i && ea(a, "script")),
          (d = h = e = null),
          f
        );
      },
        ...
        c ||
          (("none" !== (c = La(a, b)) && c) ||
            ((b = (
              ...
              ).appendTo(b.documentElement))[0].contentWindow ||
              Ja[0].contentDocument
            ).document).write(),
            b.close(),
            (c = La(a, b)),
            Ja.detach()),
    ...
    !(function () {
      ...
      if (j.style) {
        function k() {
          ...
          m.appendChild(i),
            ...
            (f = 0 === j.getClientRects().length) &&
              ...
              ((k = j.getElementsByTagName("td"))[0].style.cssText =
        ...
        (j.style.cssText = "float:left;opacity:.5"),
          ...
          ((i = d.createElement("div")).style.cssText =
    ...
    a.getComputedStyle
      ? ((Ra = function (b) {
        ...
        (Sa = function (a, b, c) {
          ...
          return (
            ("" !==
              (g = (c = c || Ra(a)) ? c.getPropertyValue(b) || c[b] : void 0) &&
              void 0 !== g) ||
    ...
    function fb(a, b, c) {
      ...
      if (0 >= e || null == e) {
        if (
          ((0 > (e = Sa(a, b, f)) || null == e) && (e = a.style[b]), Oa.test(e))
        )
          return e;
        ...
        return arguments.length
          ? ((d = n.isFunction(a)),
            this.each(function (c) {
              var e;
              1 === this.nodeType &&
                (null == (e = d ? a.call(this, c, n(this).val()) : a)
                  ? (e = "")
                  : "number" == typeof e
                  ? (e += "")
                  : n.isArray(e) &&
        ...
        return "boolean" == typeof b && "string" === c
          ...
          : this.each(function () {
              ...
              if ("string" === c)
                ...
                (void 0 !== a && "boolean" !== c) ||
                  ((b = Cb(this)) && n._data(this, "__className__", b),
                  n.attr(
                    this,
                    "class",
    ...
    (n.parseJSON = function (b) {
      ...
      (n.parseXML = function (b) {
        ...
        try {
          a.DOMParser
            ? (c = (d = new a.DOMParser()).parseFromString(b, "text/xml"))
            : (((c = new a.ActiveXObject("Microsoft.XMLDOM")).async = "false"),
              c.loadXML(b));
        } catch (e) {
          c = void 0;
        }
            ...
            k
              ? (l.ifModified &&
                ...
                204 === b || "HEAD" === l.type
                  ...
                  : 304 === b
                  ? (y = "notmodified")
                  : ((y = v.state), (s = v.data), (k = !(t = v.error))))
  ...
  (function (t, i, e) {
    ...
    function n(e, s) {
      for (var o in ((this.wrapper =
        "string" == typeof s.el ? i.querySelector(s.el) : s.el),
    ...
    (s.prototype = {
      ...
      getComputedPosition: function () {
        ...
        return (
          this.options.useTransform
            ? ((i = +(
                (s = s[h.style.transform].split(")")[0].split(", "))[12] || s[4]
              )),
              (e = +(s[13] || s[5])))
  ...
  (function (globals) {
    ...
    var each = function (items, next, callback) {
      ...
      if (
        ("function" != typeof callback && (callback = Function.prototype),
        0 === items.length)
      )
  ...
  (function (e, n) {
    ...
    e.fn.fullpage = function (N) {
      ...
      function Jn(e) {
        var n = t.round(e),
          o;
        N.css3 && N.autoScrolling && !N.scrollBar
          ? Mn("translate3d(0px, -" + n + "px, 0px)", !1)
          : N.autoScrolling && !N.scrollBar
          ? go.css("top", -n)
          : ao.scrollTop(n);
      }
        ...
        methods: {
          ...
          step: function (b, c, d) {
            var e = a(c).attr("type"),
              ...
              h = new RegExp("\\b" + e + "\\b"),
              i;
            if (e && !h.test(g.join())) throw new Error(f);
      ...
      _preload: function () {
        ...
        for (i = 0; i < this.settings.slides.length; i++)
          (this.settings.preload || this.settings.preloadImages) &&
            ...
            ((s = new Image()).src = this.settings.slides[i].src),
            (this.settings.preload || this.settings.preloadVideos) &&
              this.support.video &&
              this.settings.slides[i].video &&
              (t = this._video(this.settings.slides[i].video));
      },
      _random: function (t) {
      ...
      _goto: function (s) {
        ...
        ("random" === y || y instanceof Array) &&
          ...
          this.support.video && l
            ? (((a = this._video(l instanceof Array ? l : l.src)).loop =
  ...
  (function ($) {
    ...
    ($.fn.maximage = function (settings, helperSettings) {
      ...
      ("object" != typeof settings && void 0 !== settings) ||
        ...
        this.each(function () {
          var $self = $(this),
            ...
            Modern = {
              setup: function () {
                if ($.Slides.length > 0) {
                  ...
                  Modern.preload(0), Modern.resize();
                }
              },
              preload: function (n) {
                var $img = $("<img/>");
                $img.load(function () {
                  0 == preload_count &&
                    (Cycle.setup(), config.onFirstImageLoaded()),
                    preload_count == $.Slides.length - 1
                      ? config.onImagesLoaded($self)
                      : (preload_count++, Modern.preload(preload_count));
                }),
              ...
              resize: function () {
                $.Window.bind($.Events.RESIZE, function () {
                  $.Scroll.addClass("mc-hide-scrolls"),
                    $.Window.data("h", Utils.sizes().h).data(
                      "w",
                      Utils.sizes().w
                    ),
                    $self
            ...
            Old = {
              setup: function () {
                ...
                if (
                  ...
                  $("body").append(
                    $("<div></div>").attr("class", "mc-loader").css({
                      position: "absolute",
                      left: "-9999px",
                    })
                  ),
                  $.Slides))
                    (c =
                      0 == $.Slides[j].content.length
                        ? '<img src="' + $.Slides[j].url + '" />'
                        : $.Slides[j].content),
                      ($div = $("<div>" + c + "</div>").attr(
                        "class",
                        "mc-image mc-image-n" + j + " " + $.Slides[j].theclass
                      )),
                      $self.append($div),
                      0 == $(".mc-image-n" + j).children("img").length ||
                        $("div.mc-loader").append(
                          $(".mc-image-n" + j)
                            .children("img")
                            .first()
                            .clone()
              ...
              preload: function () {
                var t = setInterval(function () {
                  $(".mc-loader")
                    ...
                    0 == $(".not-loaded").length &&
                      ($(".mc-loader").remove(), clearInterval(t));
                }, 1e3);
              },
                ...
                var cycleOptions = $.extend(
                  {
                    ...
                    slideResize: !1,
                    easing:
                      $.BrowserTests.cssTransitions && config.cssTransitions
            ...
            Adjust = {
              center: function ($item) {
                config.verticalCenter &&
                  $item.css({
                    marginTop: (($item.height() - $.Window.data("h")) / 2) * -1,
                  }),
                  config.horizontalCenter &&
                    $item.css({
                      marginLeft:
                        (($item.width() - $.Window.data("w")) / 2) * -1,
                    });
              },
              fill: function ($item) {
                var $storageEl = $item.is("object")
                  ? $item.parent().first()
                  : $item;
                "function" == typeof config.backgroundSize
                  ? config.backgroundSize($item)
                  : "cover" == config.backgroundSize
                  ? $.Window.data("w") / $.Window.data("h") <
                    $storageEl.data("ar")
                    ? $item
                        .height($.Window.data("h"))
                        .width(
                          ($.Window.data("h") * $storageEl.data("ar")).toFixed(
                            0
                          )
                        )
                    : $item
                        .height(
                          ($.Window.data("w") / $storageEl.data("ar")).toFixed(
                            0
                          )
                        )
                        .width($.Window.data("w"))
                  : "contain" == config.backgroundSize
                  ? $.Window.data("w") / $.Window.data("h") <
                    $storageEl.data("ar")
                    ? $item
                        .height(
              ...
              maxcover: function ($item) {
                Adjust.fill($item), Adjust.center($item);
              },
            ...
            Utils = {
              browser_tests: function () {
                var $div = $("<div />")[0],
                  ...
                  obj = {
                    cssTransitions: !1,
                    cssBackgroundSize:
                      "backgroundSize" in $div.style &&
                      config.cssBackgroundSize,
                    html5Video: !1,
                    msie: !1,
                  };
                ...
                return (
                  ...
                  config.debug && (debug(" - Browser Test - "), debug(obj)),
                  obj
                );
              },
                ...
                return (
                  $self.children().each(function (i) {
                    ...
                    ((obj = {}).url = $img.attr("src")),
                      (obj.title =
                        null != $img.attr("title") ? $img.attr("title") : ""),
                      (obj.alt =
                        null != $img.attr("alt") ? $img.attr("alt") : ""),
                      (obj.theclass =
                        null != $img.attr("class") ? $img.attr("class") : ""),
                      (obj.styles =
                        null != $img.attr("style") ? $img.attr("style") : ""),
                      (obj.orig = $img.clone()),
                      (obj.datahref =
                        null != $img.attr("data-href")
                          ? $img.attr("data-href")
                          : ""),
                      (obj.content = ""),
                      $(this).find("img").length > 0 &&
                        ($.BrowserTests.cssBackgroundSize &&
                  ...
                  config.debug && (debug(" - Slide Object - "), debug(arr)),
                  arr
                );
              },
              msie: function () {
              ...
              sizes: function () {
                ...
                if ("window" == config.fillElement)
                  (sizes.h = $.Window.height()), (sizes.w = $.Window.width());
                else {
                  var $fillElement = $self.parents(config.fillElement).first();
                  0 == $fillElement.height() ||
                  1 == $fillElement.data("windowHeight")
                    ? ($fillElement.data("windowHeight", !0),
                      (sizes.h = $.Window.height()))
                    : (sizes.h = $fillElement.height()),
                    0 == $fillElement.width() ||
                    1 == $fillElement.data("windowWidth")
                      ? ($fillElement.data("windowWidth", !0),
          ...
          if (
            ...
            if ($.BrowserTests.html5Video || !$self.is("video")) {
              var to,
                $storageEl = $self.is("object")
                  ? $self.parent().first()
                  : $self;
              $.Body.hasClass("mc-old-browser") ||
                $.Body.addClass("mc-old-browser"),
          ...
          } else ($.Slides = Utils.construct_slide_object()), $.BrowserTests.cssBackgroundSize ? (config.debug && debug(" - Using Modern - "), Modern.setup()) : (config.debug && debug(" - Using Old - "), Old.setup());
        });
    }),
    ...
    (a.okvideo = function (c) {
      ...
      (d.init = function () {
        ...
        OKEvents.utils.isMobile()
          ...
          null === d.options.playlist.list
            ? "youtube" === d.options.video.provider
              ? d.loadYouTubeAPI()
              : "vimeo" === d.options.video.provider &&
                ((d.options.volume /= 100), d.loadVimeoAPI())
            : d.loadYouTubeAPI();
      }),
        (d.setOptions = function () {
          ...
          null === d.options.playlist.list &&
            (d.options.video = d.determineProvider()),
        ...
        (d.loadYouTubePlaylist = function () {
          player.loadPlaylist(
            d.options.playlist.list,
            d.options.playlist.index,
            d.options.playlist.startSeconds,
            d.options.playlist.suggestedQuality
          );
        }),
        (d.loadVimeoAPI = function () {
          a("#okplayer").replaceWith(function () {
            ...
            d.insertJS(
              "//origin-public/assets.vimeo.com/js/froogaloop2.min.js",
              function () {
                vimeoPlayerReady();
              }
            );
    ...
    var e,
      a = function (s, i) {
        ...
        function l(e, a) {
          a = a || {};
          var t,
            s = new (window.MutationObserver || window.WebkitMutationObserver)(
              function (e) {
          ...
          if (
            ...
            if (37 === a || 39 === a || 38 === a || 40 === a) {
              ...
              if (
                ...
                0 ===
                  T.container.parents("." + T.params.slideActiveClass).length
              )
                return;
              var s = {
        ...
        for (var v in i)
          if (
            ...
            f[v] = i[v];
          else for (var w in ((f[v] = {}), i[v])) f[v][w] = i[v][w];
        for (var y in h)
        ...
        if (
              ...
              if (e && T.currentBreakpoint !== e) {
                var a =
                    e in T.params.breakpoints
                      ...
                      : T.originalParams,
                  t =
                    T.params.loop && a.slidesPerView !== T.params.slidesPerView;
          ...
          (T.container[0].swiper = T),
            ...
            (T.lockSwipeToNext = function () {
              (T.params.allowSwipeToNext = !1),
                !1 === T.params.allowSwipeToPrev &&
                  T.params.grabCursor &&
                  T.unsetGrabCursor();
            }),
            (T.lockSwipeToPrev = function () {
              (T.params.allowSwipeToPrev = !1),
                !1 === T.params.allowSwipeToNext &&
                  T.params.grabCursor &&
                  T.unsetGrabCursor();
            }),
            ...
            (T.updateActiveIndex = function () {
              ...
              T.params.normalizeSlideIndex &&
                ...
                (t = Math.floor(e / T.params.slidesPerGroup)) >=
                  T.snapGrid.length && (t = T.snapGrid.length - 1),
                e !== T.activeIndex &&
                  ((T.snapIndex = t),
            ...
            (T.updateClasses = function () {
              ...
              T.params.loop &&
                0 === t.length &&
                (t = T.slides.eq(0)).addClass(T.params.slideNextClass);
              var s = a
              ...
              if (
                (T.params.loop &&
                  0 === s.length &&
                  (s = T.slides.eq(-1)).addClass(T.params.slidePrevClass),
                i.loop &&
                ...
                if (
                  (T.params.loop
                    ? ((r = Math.ceil(
                        ...
                        T.slides.length - 1 - 2 * T.loopedSlides &&
          ...
          (T.slideNext = function (e, a, t) {
            return T.params.loop
              ? !T.animating &&
                  (T.fixLoop(),
                  T.container[0].clientLeft,
                  T.slideTo(T.activeIndex + T.params.slidesPerGroup, a, e, t))
              : T.slideTo(T.activeIndex + T.params.slidesPerGroup, a, e, t);
          }),
          ...
          (T.slidePrev = function (e, a, t) {
            return T.params.loop
              ? !T.animating &&
                  (T.fixLoop(),
                  T.container[0].clientLeft,
                  T.slideTo(T.activeIndex - 1, a, e, t))
              : T.slideTo(T.activeIndex - 1, a, e, t);
          }),
          ...
          (T.setWrapperTranslate = function (e, a, t) {
            ...
            (n = 0 === o ? 0 : (e - T.minTranslate()) / o) !== T.progress &&
              T.updateProgress(e),
            ...
            cube: {
              setTranslate: function () {
                ...
                T.params.cube.shadow &&
                  (T.isHorizontal()
                    ? (0 ===
                        (a = T.wrapper.find(".swiper-cube-shadow")).length &&
                    ...
                    : 0 ===
                        (a = T.container.find(".swiper-cube-shadow")).length &&
                      ((a = e('<div class="swiper-cube-shadow"></div>')),
          ...
          (T.scrollbar = {
            ...
            draggableEvents:
              !1 !== T.params.simulateTouch || T.support.touch
                ? T.touchEvents
                : T.touchEventsDesktop,
      ...
      jQuery.validator &&
        ...
        this.submit(function (event) {
          console.log("Send request"),
            ...
            jQuery.validator
              ? $(this).valid() && $ajax_sendRequest(this)
              : $ajax_sendRequest(this);
        });
    };
  })(jQuery),
  $(function () {
  ...
  $(document).on("ready", function () {
    ...
    var pageSectionDivs = $(".page-fullpage .section"),
      ...
      mainPage = $("#mainpage"),
      resp = !0;
    (contextWindow.width() < 768 || contextWindow.height() < 680) &&
      (resp = !1);
          ...
          mainPage.width() &&
            mainPage.fullpage({
              ...
              afterRender: function () {
                ...
                if (!!document.documentMode) {
                  ...
                  for (var i = 0; i < contentColumns.length; i++)
                    contentColumns[i].height <= contextWindow.height() &&
              ...
              afterLoad: function (anchorLink, index) {
                0 === index
                  ? $.fn.fullpage.setAllowScrolling(!1, "up")
                  : $.fn.fullpage.setAllowScrolling(!0, "up");
              },
            }),
  ...
  $(function () {
    ...
    (counter.days = Math.floor(sec / 86400)),
      ...
      (counter.tick = () =>
        0 !== counter.sec
          ? (counter.sec--, counter.set(), 0)
          : 0 !== counter.min
          ? (counter.min--, (counter.sec = 59), counter.set(), 0)
          : 0 !== counter.hours
          ? (counter.hours--,
            (counter.min = 59),
            (counter.sec = 59),
